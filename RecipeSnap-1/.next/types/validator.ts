...
// Validate ../../src/pages/my-recipes.tsx
{
  const handler = {} as typeof import("../../src/pages/my-recipes.js")
  handler satisfies PagesPageConfig
}

// Validate ../../src/pages/recipes/[recipe].tsx
{
  const handler = {} as typeof import("../../src/pages/recipes/[recipe].js")
  handler satisfies PagesPageConfig
}
